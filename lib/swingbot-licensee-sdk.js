(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("SwingbotLicenseeSDK", [], factory);
	else if(typeof exports === 'object')
		exports["SwingbotLicenseeSDK"] = factory();
	else
		root["SwingbotLicenseeSDK"] = factory();
 ...
 * the main function!
 */
var uploadVideo = function uploadVideo(file, email, processType, licenseeCampaignId, apiKey) {
  return getSignedUrl(file.name, apiKey).then(function (urlResults) {
    return uploadVideoFile(urlResults.data.url, file);
  }).then(function (uploadResult) {
    return processVideoFile(file.name, email, processType, licenseeCampaignId, apiKey);
  }).catch(function (err) {
    return err;
  });
};
...
//# sourceMappingURL=swingbot-licensee-sdk.js.map